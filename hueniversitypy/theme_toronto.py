def theme_toronto(palette='cool'):
    ...
    Three palettes based on the U of T identity guidelines can be selected, 'cool', 'vibrant' and 'awards'. 
    ...
    altair plot : altair.vegalite.v4.api.Chart
    	an altair plot with the University of Toronto visual identity colour theme applied. 
